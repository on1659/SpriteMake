...
- Generated attempts folder: output/sprite-20260505-014526/generated/
- QA folder: output/sprite-20260505-014526/qa/
- Final folder: output/sprite-20260505-014526/final/
- Manifest folder: output/sprite-20260505-014526/manifests/
- Tool folder: output/sprite-20260505-014526/tools/
- Prompt variants folder: output/sprite-20260505-014526/prompts/

## Generation Decision

- Mode: codex / local generated attempt
- SpriteMake does not store API keys and does not call the image API directly.
- Keyless Codex direct path: use the copy-ready prompt below without API keys; model selection is not user-selectable or verified as gpt-image-2.
...
- A local deterministic starter attempt is generated by tools/generate_hamster_care_sprites.py and saved under generated/.
...
- Batch folder: output/sprite-20260505-014526
- Save raw generated attempts under: output/sprite-20260505-014526/generated/
- Save QA notes and screenshots under: output/sprite-20260505-014526/qa/
- Only QA-passed files may be moved to: output/sprite-20260505-014526/final/
...
- The Y baseline/source plane is y=220.
