# scooter-lose gpt-image-2 Prompt
...
- Vehicle ID: scooter
- Asset ID: scooter-lose
- Vehicle Korean label: 스쿠터
- Pose family: stopped and tilted / sinking posture
- Visual direction override: 파란 스쿠터, 정지, 라이더 어깨 처짐, 헬멧 위에 물방울
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'scooter' base svgMap run.frame1 state around line 363. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.

- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/scooter-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/scooter-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/scooter-lose.png

Per-Asset Visual Direction:
- Base color family: blue scooter, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 멈춘 스쿠터와 처진 라이더.
- Frame 1: 헬멧 위 물방울이 1px 움직임.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/scooter-lose.html
