# turtle-lose gpt-image-2 Prompt
...
- Vehicle ID: turtle
- Asset ID: turtle-lose
- Vehicle Korean label: 거북이
- Pose family: kneel / sit-low / discouraged posture
- Visual direction override: 초록색 거북이, 머리와 다리가 등껍질 안으로 절반쯤 들어감, 등껍질 위에 작은 구름
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'turtle' base svgMap run.frame1 state around line 275. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.

- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/turtle-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/turtle-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/turtle-lose.png

Per-Asset Visual Direction:
- Base color family: green shell, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 등껍질 안으로 움츠림.
- Frame 1: 구름이 살짝 위로 움직이고 머리가 1px 더 들어감.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/turtle-lose.html
