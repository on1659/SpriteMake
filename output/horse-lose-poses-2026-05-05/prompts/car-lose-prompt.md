...
- Vehicle ID: car
- Asset ID: car-lose
- Vehicle Korean label: 자동차
- Pose family: stopped and tilted / sinking posture
- Visual direction override: 빨간색 컴팩트카, 정지 상태, 보닛 위에 작은 구름, 약간 처진 차체(서스펜션 압축)
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'car' base svgMap run.frame1 state around line 3. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.

- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/car-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/car-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/car-lose.png

Per-Asset Visual Direction:
- Base color family: red compact car, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 멈춘 차체가 살짝 처짐.
- Frame 1: 구름이 움직이고 차체가 1px 더 내려앉음.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/car-lose.html
