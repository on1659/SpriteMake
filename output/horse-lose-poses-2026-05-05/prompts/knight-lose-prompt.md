# knight-lose gpt-image-2 Prompt
...
- Vehicle ID: knight
- Asset ID: knight-lose
- Vehicle Korean label: 기사
- Pose family: kneel / sit-low / discouraged posture
- Visual direction override: 은색 갑옷 기사, 한쪽 무릎 꿇음, 검 끝을 땅에 짚음, 투구 안 눈은 ㅠㅠ 또는 가늘게
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'knight' base svgMap run.frame1 state around line 886. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.

- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/knight-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/knight-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/knight-lose.png

Per-Asset Visual Direction:
- Base color family: silver armor, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 검을 땅에 짚고 한쪽 무릎 꿇음.
- Frame 1: 투구가 1px 숙여지고 한숨 효과 이동.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/knight-lose.html
