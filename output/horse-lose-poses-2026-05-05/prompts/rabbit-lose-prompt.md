# rabbit-lose gpt-image-2 Prompt
...
- Vehicle ID: rabbit
- Asset ID: rabbit-lose
- Vehicle Korean label: 토끼
- Pose family: kneel / sit-low / discouraged posture
- Visual direction override: 흰색/회색 토끼, 양쪽 귀가 머리 옆으로 축 처짐, 한쪽 발 펴고 앉아있는 자세
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'rabbit' base svgMap run.frame1 state around line 217. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.

- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/rabbit-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/rabbit-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/rabbit-lose.png

Per-Asset Visual Direction:
- Base color family: white/gray, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 귀가 처진 채 주저앉음.
- Frame 1: 한숨과 함께 몸이 1px 가라앉음.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/rabbit-lose.html
