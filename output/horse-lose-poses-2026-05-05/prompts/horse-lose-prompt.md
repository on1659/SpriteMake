...
- Vehicle ID: horse
- Asset ID: horse-lose
- Vehicle Korean label: 말
- Pose family: kneel / sit-low / discouraged posture
- Visual direction override: 갈색/베이지 말, 갈기 헝클어짐, 눈은 ㅠㅠ 모양
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'horse' base svgMap run.frame1 state around line 463. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.
- Additional image reference: D:\Work\LAMDiceBot\assets\backgrounds\vehicle-flat\horse.png, copied to SpriteMake source/horse-flat-reference.png for reference only.
- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/horse-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/horse-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/horse-lose.png

Per-Asset Visual Direction:
- Base color family: brown/beige, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 무릎 꿇음 + 고개 숙임.
- Frame 1: 한숨 구름이 살짝 움직이고 몸이 1px 들썩임.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/horse-lose.html
