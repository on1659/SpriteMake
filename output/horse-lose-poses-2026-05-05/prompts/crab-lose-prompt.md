...
- Vehicle ID: crab
- Asset ID: crab-lose
- Vehicle Korean label: 게
- Pose family: kneel / sit-low / discouraged posture
- Visual direction override: 빨간 게, 양 집게가 옆으로 늘어짐(위로 안 쳐듦), 다리 4개 살짝 굽힘, 머리 위 작은 거품
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'crab' base svgMap run.frame1 state around line 2027. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.

- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/crab-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/crab-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/crab-lose.png

Per-Asset Visual Direction:
- Base color family: red crab, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 집게를 옆으로 늘어뜨리고 주저앉음.
- Frame 1: 거품이 1px 움직이고 몸이 낮아짐.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/crab-lose.html
