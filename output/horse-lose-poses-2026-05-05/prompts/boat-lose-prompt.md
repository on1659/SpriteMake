...
- Vehicle ID: boat
- Asset ID: boat-lose
- Vehicle Korean label: 배
- Pose family: stopped and tilted / sinking posture
- Visual direction override: 나무 보트, 한쪽으로 15도 기울어짐, 돛이 펄럭이지 않고 늘어짐, 작은 거품 옆에
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'boat' base svgMap run.frame1 state around line 135. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.

- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/boat-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/boat-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/boat-lose.png

Per-Asset Visual Direction:
- Base color family: wooden boat, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 한쪽으로 15도 기울어 가라앉기 시작함.
- Frame 1: 거품이 움직이고 배가 1px 내려앉음.
- Effect: small bubble cluster, about 8x8 px, above the head/body and fully inside each 60x45 cell.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/boat-lose.html
