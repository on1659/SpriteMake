# rocket-lose gpt-image-2 Prompt
...
- Vehicle ID: rocket
- Asset ID: rocket-lose
- Vehicle Korean label: 로켓
...
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'rocket' base svgMap run.frame1 state around line 49. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.

- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/rocket-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/rocket-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/rocket-lose.png

Per-Asset Visual Direction:
- Base color family: red rocket, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 분사 없이 5도 기울어진 로켓.
- Frame 1: 연기가 1px 이동하고 로켓이 살짝 가라앉음.
- Effect: small gray smoke puff, about 8x8 px, above the head/body and fully inside each 60x45 cell.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/rocket-lose.html
