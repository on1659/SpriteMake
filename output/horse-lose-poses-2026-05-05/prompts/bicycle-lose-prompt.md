# bicycle-lose gpt-image-2 Prompt
...
- Vehicle ID: bicycle
- Asset ID: bicycle-lose
- Vehicle Korean label: 자전거
- Pose family: stopped and tilted / sinking posture
- Visual direction override: 자전거가 약 10도 기울어짐, 라이더는 핸들 잡고 고개 숙임, 머리 위 물방울
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'bicycle' base svgMap run.frame1 state around line 169. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.

- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/bicycle-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/bicycle-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/bicycle-lose.png

Per-Asset Visual Direction:
- Base color family: bicycle with rider, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 자전거와 라이더가 10도 기울어짐.
- Frame 1: 물방울과 고개가 1px 움직임.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/bicycle-lose.html
