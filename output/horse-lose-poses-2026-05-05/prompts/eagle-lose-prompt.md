...
- Vehicle ID: eagle
- Asset ID: eagle-lose
- Vehicle Korean label: 독수리
- Pose family: kneel / sit-low / discouraged posture
- Visual direction override: 갈색/검정 독수리, 양 날개 몸통에 붙임, 부리 닫고 시선 아래로, 깃털 약간 헝클어짐
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'eagle' base svgMap run.frame1 state around line 315. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.

- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/eagle-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/eagle-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/eagle-lose.png

Per-Asset Visual Direction:
- Base color family: brown/black eagle, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 날개 접고 고개 숙임.
- Frame 1: 깃털과 한숨이 1px 움직임.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/eagle-lose.html
