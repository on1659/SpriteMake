...
- Vehicle ID: bird
- Asset ID: bird-lose
- Vehicle Korean label: 새
- Pose family: stopped and tilted / sinking posture
- Visual direction override: 파란/노란 작은 새, 양 날개 몸통에 붙임, 머리 살짝 숙임, 깃털 1개 떨어지는 효과
- Existing asset/style reference: Do not use POWER_VEHICLE_VARIANT_OVERRIDES or booster/power art.  match D:\Work\LAMDiceBot\js\horse-race-sprites.js vehicle 'bird' base svgMap run.frame1 state around line 91. Match its chunky pixel silhouette, facing direction, and 1-2 px black outline.

- In-game display scale: 60x45 px.
- Target game file path after QA: assets/horse-race/sprites/lose/bird-lose.png
- Local generated file expected by preview manifest: output/horse-lose-poses-2026-05-05/generated/bird-lose.png
- Local final file after QA: output/horse-lose-poses-2026-05-05/final/bird-lose.png

Per-Asset Visual Direction:
- Base color family: blue/yellow bird, keeping original hue with saturation reduced to about 75-80%.
- Frame 0: 날개 접고 머리 숙임.
- Frame 1: 깃털과 머리가 1px 움직임.
- Effect: single falling feather plus tiny sigh, about 8x8 px, above the head/body and fully inside each 60x45 cell.
...
- Tool output path: output/horse-lose-poses-2026-05-05/tools/bird-lose.html
